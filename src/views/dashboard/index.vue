      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            <p class="firstChild">hello，{{ name }}，欢迎登录火星空间站!</p>
            <!-- 辅助函数 -->
            <p class="lastChild">{{ name }} | Mars空间站  </p>
          </div>
        </div>
        <div class="fr" />
      </div>
              ...
              <ul class="noticeList">
                <li>
                  <div class="item">
                    ...
                    <div>
                      <p><span class="col">Lavi</span> 发布了 第1期“火星大讲堂”互动讨论获奖名单公布</p>
                ...
                <li>
                  <div class="item">
                    <img src="@/assets/common/img.jpeg" alt="">
                    <div>
                      <p><span class="col">Lavi</span> 发布了 第2期“火星大讲堂”互动讨论获奖名单公布</p>
                      <p>2018-07-21 15:21:38</p>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="item">
                    <img src="@/assets/common/img.jpeg" alt="">
                    <div>
                      <p><span class="col">Lavi</span> 发布了 第3期“火星大讲堂”互动讨论获奖名单公布</p>
                      <p>2018-07-21 15:21:38</p>
                    </div>
                  </div>
                </li>
